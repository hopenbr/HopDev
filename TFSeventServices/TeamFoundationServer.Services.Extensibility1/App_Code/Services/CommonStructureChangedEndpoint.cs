...
/// <summary>
/// Web Service Endpoint for the <see cref="CommonStructureChangedEvent"/>
/// </summary>
/// <remarks>
...
public class CommonStructureChangedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="CommonStructureChangedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="CommonStructureChangedEvent"/></param>
    ...
    {
        CommonStructureChangedEvent commonStructureChangedEvent = this.CreateInstance<CommonStructureChangedEvent>(eventXml);
