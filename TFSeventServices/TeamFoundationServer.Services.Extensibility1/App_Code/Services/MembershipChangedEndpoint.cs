...
/// <summary>
/// Web Service Endpoint for the <see cref="MembershipChangedEvent"/>
/// </summary>
/// <remarks>
...
public class MembershipChangedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="MembershipChangedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="MembershipChangedEvent"/></param>
    ...
    {
        MembershipChangedEvent membershipChangedEvent = this.CreateInstance<MembershipChangedEvent>(eventXml);
