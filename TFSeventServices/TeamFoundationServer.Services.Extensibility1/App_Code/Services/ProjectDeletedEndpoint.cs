...
/// <summary>
/// Web Service Endpoint for the <see cref="ProjectDeletedEvent"/>
/// </summary>
/// <remarks>
...
public class ProjectDeletedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="ProjectDeletedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="ProjectDeletedEvent"/></param>
    ...
    {
        ProjectDeletedEvent projectDeletedEvent = this.CreateInstance<ProjectDeletedEvent>(eventXml);
