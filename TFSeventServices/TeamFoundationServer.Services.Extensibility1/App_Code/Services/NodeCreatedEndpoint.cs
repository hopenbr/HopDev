...
/// <summary>
/// Web Service Endpoint for the <see cref="NodeCreatedEvent"/>
/// </summary>
/// <remarks>
...
public class NodeCreatedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="NodeCreatedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="NodeCreatedEvent"/></param>
    ...
    {
        NodeCreatedEvent nodeCreatedEvent = this.CreateInstance<NodeCreatedEvent>(eventXml);
