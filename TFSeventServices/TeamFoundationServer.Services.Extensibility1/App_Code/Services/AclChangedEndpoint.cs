...
/// <summary>
/// Web Service Endpoint for the <see cref="AclChangedEvent"/>
/// </summary>
/// <remarks>
...
public class AclChangedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="AclChangedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="AclChangedEvent"/></param>
