...
/// <summary>
/// Web Service Endpoint for the <see cref="ProjectCreatedEvent"/>
/// </summary>
/// <remarks>
...
public class ProjectCreatedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="ProjectCreatedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="ProjectCreatedEvent"/></param>
    ...
    {
        ProjectCreatedEvent projectCreatedEvent = this.CreateInstance<ProjectCreatedEvent>(eventXml);
