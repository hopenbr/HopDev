...
/// <summary>
/// Web Service Endpoint for the <see cref="NodeRenamedEvent"/>
/// </summary>
/// <remarks>
...
public class NodeRenamedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="NodeRenamedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="NodeRenamedEvent"/></param>
    ...
    {
        NodeRenamedEvent nodeRenamedEvent = this.CreateInstance<NodeRenamedEvent>(eventXml);
