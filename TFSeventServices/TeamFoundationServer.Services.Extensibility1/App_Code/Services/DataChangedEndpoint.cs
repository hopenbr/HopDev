...
/// <summary>
/// Web Service Endpoint for the <see cref="DataChangedEvent"/>
/// </summary>
/// <remarks>
...
public class DataChangedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="DataChangedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="DataChangedEvent"/></param>
    ...
    {
        DataChangedEvent dataChangedEvent = this.CreateInstance<DataChangedEvent>(eventXml);
