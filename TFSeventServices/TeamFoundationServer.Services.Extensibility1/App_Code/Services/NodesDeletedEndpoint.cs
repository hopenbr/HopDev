...
/// <summary>
/// Web Service Endpoint for the <see cref="NodesDeletedEvent"/>
/// </summary>
/// <remarks>
...
public class NodesDeletedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="NodesDeletedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="NodesDeletedEvent"/></param>
