...
/// <summary>
/// Web Service Endpoint for the <see cref="IdentityDeletedEvent"/>
/// </summary>
/// <remarks>
...
public class IdentityDeletedEndpoint : TeamFoundationServer.Services.Extensibility1.EndpointBase
{
    /// <summary>
    /// Endpoint required to accept incoming <see cref="IdentityDeletedEvent"/> notifications
    /// </summary>
    /// <param name="eventXml">Serialized version of the <see cref="IdentityDeletedEvent"/></param>
    ...
    {
        IdentityDeletedEvent identityDeletedEvent = this.CreateInstance<IdentityDeletedEvent>(eventXml);
